...
.center[![Webコンテンツのスマホアプリ化イメージ](readme-img/Webコンテンツのスマホアプリ化イメージ.png)]
.center[
...
.size_small_9[
* プロジェクトをインポートします
 * 今回はmBaaSとの連携部分以外の処理に関しては、既に実装済みのプロジェクトを用意しました。アプリとサーバー間の連携部分のコーディングを体験していただけます。
...
.center[![動作確認①-1](readme-img/動作確認①-1.png)]
...
.center[![動作確認①-2](readme-img/動作確認①-2.png)]
...
お気に入りの情報はスマホのローカルストレージに保存されています。したがって、「お気に入り」情報は、自分にしか見れません。また、機種変更したら見られなくなってしまいます。

.center[![動作確認①-3](readme-img/動作確認①-3.png)]
...
.center[![完成イメージ1](readme-img/完成イメージ1.png)]
...
.center[![mBaaS準備2-2](readme-img/mBaaS準備2-2.png)]
...
### 4. お気に入り機能をオンライン化する
完成イメージ
.center[![完成イメージ2](readme-img/完成イメージ2.png)]
...
.center[![SDK導入4](readme-img/SDK導入4.png)]
...
.center[![Monaca_index](readme-img/Monaca_index.png)]
...
.center[![code_API](readme-img/code_API.png)]
...
.center[![code_offline_to_online](readme-img/code_offline_to_online.png)]
...
.center[![Monaca_online](readme-img/Monaca_online.png)]
...
.center[![code_1](readme-img/code_1.png)]
.size_large_11[
##### (2) 保存先クラスの定義
]
☆をタップするとお気に入り登録ができます。そのデータの保存先クラス`favorite`をここで定義しています
.center[![code_2](readme-img/code_2.png)]
.size_large_11[
##### (3) 保存するオブジェクトの生成
]
.center[![code_3](readme-img/code_3.png)]
...
.center[![code_4](readme-img/code_4.png)]
...
.center[![code_5](readme-img/code_5.png)]
...
.center[![code_6](readme-img/code_6.png)]
...
.center[![code_7](readme-img/code_7.png)]
...
.center[![dummy_uuid](readme-img/dummy_uuid.png)]
...
.center[![dummy_debugger](readme-img/dummy_debugger.png)]

---
## まとめ
.size_large_13[
* 既存Webコンテンツのスマホアプリ化を体験しました
